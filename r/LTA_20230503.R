# ANÁLISIS OGIVAS DE MADUREZ LTA.
# ICCAT 2023
# DAVID MACÍAS
# 2023 05 03
# Basado en:
...
datuak <- read.csv('LTA_TOTAL_Rev-DM_MAP_20230503.csv',
                   header = TRUE,
...
#[1] 0
names(datuak)
#[1] "Year"           "Species"        "ScI_Name"       "Stock_Sp"       "FL_cm"         
#[6] "Maturity_stage"
unique(datuak$Species)
unique(datuak$Stock_Sp)
#[1] "MEDI_NE ATL" "NE_SE_ATL"  
unique(datuak$Maturity_stage)
#[1] "Inmature"   "Mature"     ""           "Decidir ¿?"
...
datuak$Stock_Sp <- factor(datuak$Stock_Sp)
